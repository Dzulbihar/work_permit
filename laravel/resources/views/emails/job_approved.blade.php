...
<body>
    <div class="email-container">
        <div class="email-header">
            Pengajuan Izin Kerja Disetujui
        </div>
        <div class="email-body">
            <h2>Halo,</h2>
            <p>Pengajuan izin kerja Anda telah disetujui. Berikut detailnya:</p>
            <p><strong>Nama Pekerjaan:</strong> {{ $jobName }}</p>
            <p><strong>Deskripsi Pekerjaan:</strong> {{ $jobDesc }}</p>
            
            <p>
            	<strong>Tanggal Bertemu:</strong> 
            	{{ \Carbon\Carbon::parse($meetingDate)->locale('id')->translatedFormat('l, d F Y') }}
            </p>
