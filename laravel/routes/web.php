...
Route::group(['middleware' => ['auth']], function() {
	...
	Route::group(['middleware' => ['checkRole:hsse,fungsional']], function() {
		...
		Route::post('/job_desc/status/approve_fungsional/{id}', [App\Http\Controllers\JobDescController::class, 'approve_fungsional'])->name('job_desc.approve_fungsional');
